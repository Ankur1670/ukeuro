                                ...
                                <div className="section-content">
                                    <div className="row">
                                        ...
                                        <div className="col-md-12">
                                            <h2 className="font-size-38 mt-0">Accredited    <span className="text-theme-colored">Body</span></h2>
                                            ...
                                            <div style={{overflow:"auto"}}>
                                                ...
                                                <div className="table-responsive">
                                                    <table className="table table-bordered" align="center">
                                                        <thead>
                                                        <tr>
                                                            <th style={{color:"#196ABB"}}>Cab Name</th>
                                                        ...
                                                        <tr>
                                                            <th style={{color:"#196ABB"}}>Contact Person</th>
                                                            <td>{response.name}</td>
